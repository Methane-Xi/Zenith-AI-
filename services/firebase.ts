 ...
 * 
 * INTEGRATION NOTE: To fix 'auth/unauthorized-domain', you MUST add
 * the hostname displayed in the console to:
...
// FIX: Forces account selection (fixes sticky login bugs)
